...
class Mecab
  ...
  def sparse_tostr(stg)
    MecabImporter.mecab_sparse_tostr(@mecab,stg)
  end
  
  def nbest_sparse_tostr(nbest,stg)
    MecabImporter.mecab_nbest_sparse_tostr(@mecab,nbest,stg)
  end
  
  def nbest_init(stg)
    MecabImporter.mecab_nbest_init(@mecab,stg)
  end
  ...
  def sparse_tonode(stg)
    Node.new MecabImporter.mecab_sparse_tonode(@mecab, stg)
  end
